...
static PyObject *Video_device_set_hue_auto(
  Video_device * self,
  PyObject * args) {
...
static PyObject *Video_device_set_saturation(
  Video_device * self,
  PyObject * args) {
...
static PyObject *Video_device_set_contrast(
  Video_device * self,
  PyObject * args) {
...
static PyObject *Video_device_set_gain_auto(
  Video_device * self,
  PyObject * args) {
...
static PyMethodDef Video_device_methods[] = {
  ...
  {"set_brightness", (PyCFunction) Video_device_set_brightness,
   ...
   "choose another value than requested and will return its choice. "},
  {"set_hue_auto", (PyCFunction) Video_device_set_hue_auto,
   METH_VARARGS,
   "set_hue_auto(auto) -> auto  hue\n\n"
   "Request the video device to set hue to value. The device may "
   "choose another value than requested and will return its choice. "},
  {"set_gain_auto", (PyCFunction) Video_device_set_gain_auto,
   METH_VARARGS,
   "set_gain_auto(auto) -> auto  gain\n\n"
   "Request the video device to set gain to value. The device may "
   "choose another value than requested and will return its choice. "},
  {"set_gain", (PyCFunction) Video_device_set_gain,
   METH_VARARGS,
   "set_gain(auto) -> auto  gain\n\n"
   "Request the video device to set gain to value. The device may "
   "choose another value than requested and will return its choice. "},
  {"set_contrast", (PyCFunction) Video_device_set_contrast,
   METH_VARARGS,
   "set_contrast(auto) -> contrast\n\n"
   "Request the video device to set contrast to value. The device may "
   "choose another value than requested and will return its choice. "},
  {"set_saturation", (PyCFunction) Video_device_set_saturation,
   METH_VARARGS,
   "set_saturation(auto) -> saturation \n\n"
   "Request the video device to set saturation to value. The device may "
   "choose another value than requested and will return its choice. "},
